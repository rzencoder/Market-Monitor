...
var socket = io.connect( "https://marketmonitor.herokuapp.com/");
    ...
    return (
      ...
      <div className="App">
        ...
        <div className="main-container">
          <Aside stocks={this.state.stocks}
          ...
          <div className="content-container">
            ...
            <div className="chart-container">
              {this.state.loading ? <div className="load"><div className="loader"></div></div> : ''}
              <div id="chart" className="chart">
                {!this.state.loading ? <Chart stocks={this.state.stocks} /> : ''}
              </div>
            </div>
          </div>
        </div>
